...
python localTensoRF/train.py --datadir  ${OUTDIR}/TNT/Church_3000_upsampled_x2_6_fps/ --logdir ${OUTDIR}/localrf_results/debug_patch_sample \
 --fov 71 --loss_flow_weight_inital 0 --add_frames_every 600