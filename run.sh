...
python localTensoRF/ev_train.py --datadir  ${OUTDIR}/TNT/Church_3000_upsampled_x2_2_fps/ \
 --fov 71 --loss_flow_weight_inital 0 --loss_depth_weight_inital 0.1 \
  --eventdir ${OUTDIR}/TNT/Church_3000_upsampled_x2_2_fps/acc_events \
  --add_frames_every 200 --events_in_imgs 2 --batch_size 4096 \
  --logdir ${OUTDIR}/localrf_results/optim_speed \
